...
public abstract class Trap {
	...
	public int successFormula(NPC npc) {
		...
		chance = chance + (int) (player.getSkills().getLevel(Skill.HUNTER) / 1.5) + 10;

		if(player.getSkills().getLevel(Skill.HUNTER) < 65) {
			chance = (int) (chance * 1.05) + 3;
		} else if(player.getSkills().getLevel(Skill.HUNTER) < 60) {
			chance = (int) (chance * 1.1);
		} else if(player.getSkills().getLevel(Skill.HUNTER) < 55) {
			chance = (int) (chance * 1.2);
		} else if(player.getSkills().getLevel(Skill.HUNTER) < 50) {
			chance = (int) (chance * 1.3) + 1;
		} else if(player.getSkills().getLevel(Skill.HUNTER) < 40) {
			chance = (int) (chance * 1.4) + 3;
		} else if(player.getSkills().getLevel(Skill.HUNTER) < 25) {
