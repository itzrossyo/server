...
import valius.content.QuickSets;
import valius.content.RecolourGraceful;
import valius.content.StatReset;
...
import valius.content.teleportation.TeleportationDevice;
...
public class FiveOptions {
	...
	public static void handleOption1(Player c) {
		...
		if (c.dialogueAction == 114) {
			if (c.getItems().playerHasItem(6737, 1) && c.getItems().playerHasItem(13307, 1000)) {
				c.getItems().deleteItem(6737, 1);
				c.getItems().deleteItem(13307, 1000);
				c.getItems().addItem(11773, 1);
				c.sendMessage("You imbue your berserker ring for the cost of @blu@1000 Bloodmoney@bla@.");
				c.getPA().removeAllWindows();
				c.dialogueAction = 0;
			} else {
				c.sendMessage("You need 1000 Bloodmoney and a Berserker ring to do this.");
				c.getPA().removeAllWindows();
				c.dialogueAction = 0;
			}
			return;
		...
		if (c.dialogueAction == 135) {
			if (c.getItems().playerHasItem(12605, 1) && c.getItems().playerHasItem(13307, 1000)) {
				c.getItems().deleteItem(12605, 1);
				c.getItems().deleteItem(13307, 1000);
				c.getItems().addItem(12692, 1);
				c.sendMessage("You imbue your treasonous ring for the cost of @blu@1000 Bloodmoney@bla@.");
				c.getPA().removeAllWindows();
				c.dialogueAction = 0;
			} else {
				c.sendMessage("You need 1000 Bloodmoney and a Treasonous ring to do this.");
				c.getPA().removeAllWindows();
				c.dialogueAction = 0;
			}
			return;
	...
	case 711:
		...
		if (c.dialogueAction == 114) {
			if (c.getItems().playerHasItem(6733, 1) && c.getItems().playerHasItem(13307, 1000)) {
				c.getItems().deleteItem(6733, 1);
				c.getItems().deleteItem(13307,  1000);
				c.getItems().addItem(11771, 1);
				c.sendMessage("You imbue your archer ring for the cost of @blu@1000 Bloodmoney@bla@.");
				c.getPA().removeAllWindows();
				c.dialogueAction = 0;
			} else {
				c.sendMessage("You need 1000 Bloodmoney and an Archer ring to do this.");
				c.dialogueAction = 0;
				c.getPA().removeAllWindows();
			}
			return;
		...
		if (c.dialogueAction == 135) {
			if (c.getItems().playerHasItem(12603, 1) && c.getItems().playerHasItem(13307, 1000)) {
				c.getItems().deleteItem(12603, 1);
				c.getItems().deleteItem(13307, 1);
	...
	case 193193:
		...
		if (c.dialogueAction == 114) {
			if (c.getItems().playerHasItem(6731, 1) && c.getItems().playerHasItem(13307, 1000)) {
				c.getItems().deleteItem(6731, 1);
				c.getItems().deleteItem(13307, 1000);
				c.getItems().addItem(11770, 1);
				c.sendMessage("You imbue your seers ring for the cost of @blu@1000 Bloodmoney@bla@.");
				c.getPA().removeAllWindows();
				c.dialogueAction = 0;
			} else {
				c.sendMessage("You need 1000 Bloodmoney and n Seers ring to do this.");
				c.getPA().removeAllWindows();
				c.dialogueAction = 0;
			}
			return;
	...
	public static void handleOption4(Player c) {
		if(c.getActiveDialogue() != null && c.getActiveDialogue() instanceof OptionDialogue) {
			((OptionDialogue)c.getActiveDialogue()).next(c, 4);
			return;
		}
		switch (c.dialogueAction) {		
		case 851:
		...
		if (c.dialogueAction == 114) {
			if (c.getItems().playerHasItem(6735, 1) && c.getItems().playerHasItem(13307, 1000)) {
				c.getItems().deleteItem(6735, 1);
				c.getItems().deleteItem(13307, 1000);
				c.getItems().addItem(11772, 1);
				c.sendMessage("You imbue your warrior ring for the cost of @blu@1000 BloodmoneyP@bla@.");
				c.getPA().removeAllWindows();
				c.dialogueAction = 0;
			} else {
				c.sendMessage("You need 1000 Bloodmoney and n Warrior ring to do this.");
				c.getPA().removeAllWindows();
				c.dialogueAction = 0;
			}
			return;
	...
	public static void handleOption5(Player c) {
		if(c.getActiveDialogue() != null && c.getActiveDialogue() instanceof OptionDialogue) {
			((OptionDialogue)c.getActiveDialogue()).next(c, 5);
			return;
		}
		switch (c.dialogueAction) {
		case 711:
