...
public class CrawsGreen extends ItemCombination {

	public CrawsGreen(Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendItemStatement("You combined the items and created the Craws bow (Toxic).", 33783);
		player.crawCharge = 0;
