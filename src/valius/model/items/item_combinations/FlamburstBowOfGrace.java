...
public class FlamburstBowOfGrace extends ItemCombination {

	public FlamburstBowOfGrace(Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendItemStatement("You combined the items and created the Flamburst bow of grace.", 33813);
