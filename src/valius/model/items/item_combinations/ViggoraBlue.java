...
public class ViggoraBlue extends ItemCombination {

	public ViggoraBlue(Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendItemStatement("You combined the items and created the Viggoras chainmace (Blue flame).", 33778);
