...
public abstract class ItemContainer {
	...
	/**
	 * The maximum amount of {@link Item} items that can be stored in the container.
	 */
	protected final int capacity;

	/**
	 * An array of {@link Item} items that exist in the container
	 */
	protected Item[] items;

	/**
	 * Determines if this container permittes duplicate items. Items are deemed duplicates if the identification value of one {@link Item} matches another.
	 */
	 ...
	 */
	public abstract void add(Item item, int slot);
	 ...
	 */
	public abstract void remove(Item item, int slot);
