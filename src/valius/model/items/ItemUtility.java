...
public class ItemUtility {
	...
	public static int boots[] = { 11840, 7596, 8029, 6619, 8017, 7159, 7991, 6666, 6061, 6106, 88, 89, 626, 628, 630,
			...
			6920, 6349, 6357, 3393, 9073, 10933, 7114, 33110 };
	...
	public static int gloves[] = { 7595, 6629, 8021, 8016, 7964, 2491, 1065, 2487, 2489, 3060, 1495, 775, 777, 778,
			...
			3391, 9072, 20090, 20091, 20092, 20093, 33109 };
	...
	public static int shields[] = { 11283, 20846, 7676, 7342, 7348, 7354, 7360, 7334, 7340, 7347, 7352, 7358, 7356, 7350, 7344,
			...
			4156, 4224, 4225, 4226, 4227, 4228, 4329, 4230, 4231, 4232, 4233, 4234, 4302, 4507, 4512, 6215, 6217, 6219,
			6221, 6223, 6225, 6227, 6329, 6231, 6233, 6235, 6237, 6239, 6241, 6243, 6245, 6247, 6249, 6251, 6253, 6255,
			6257, 6259, 6261, 6263, 6265, 6267, 6269, 6271, 6273, 6275, 6277, 6279, 6524, 6889, 22275, 22278, 22281, 22284, 32991, 
			33115 };

	/**
	 * Server hat IDs.
	 */
	public static int hats[] = { 9925, 33732, 33737, 33742, 23448, 33106, 13137, 33105, 33131, 33106, 13138, 13139, 3057, 20838, 2679, 2685, 2682, 2703, 2688, 2691, 2691,
			2733, 2736, 2718, 2730, 2697, 2715, 2727, 2724, 2709, 2706, 2712, 2721, 2739, 2700, 2518, 2524, 2526, 7319,
			7321, 7323, 7325, 7327, 1167, 8077, 8076, 8074, 4168, 1169, 8034, 8035, 8036, 8030, 6623, 8024, 8023, 8022,
			8013, 1169, 7594, 7995, 7996, 7997, 7998, 7999, 8000, 8001, 7992, 7990, 7975, 7973, 7971, 7967, 7963, 6665,
			6665, 7321, 6886, 6547, 6548, 2645, 2647, 2649, 4856, 4857, 4858, 4859, 4880, 4881, 4882, 4883, 4904, 4905,
			4906, 4907, 4928, 4929, 4930, 4931, 4952, 4953, 4954, 4955, 4976, 4977, 4978, 4979, 4732, 4753, 4611, 6188,
			6182, 4511, 4056, 4071, 4724, 2639, 2641, 2643, 2665, 6109, 5525, 5527, 5529, 5531, 5533, 5535, 5537, 5539,
			5541, 5543, 5545, 5547, 5549, 5551, 74, 579, 656, 658, 660, 662, 664, 740, 1017, 1037, 1040, 1042, 1044,
			1046, 1038, 1048, 1050, 1053, 1055, 1057, 1137, 1139, 1141, 1143, 1145, 1147, 1149, 1151, 1153, 1155, 1157,
			1159, 1161, 1163, 1165, 1506, 1949, 2422, 2581, 2587, 2595, 2605, 2613, 2619, 2627, 2631, 2633, 2635, 2637,
			2651, 2657, 2673, 2900, 2910, 2920, 2930, 2940, 2978, 2979, 2980, 2981, 2982, 2983, 2984, 2985, 2986, 2987,
			2988, 2989, 2990, 2991, 2992, 2993, 2994, 2995, 3057, 3385, 3486, 3748, 3749, 3751, 3753, 3797, 4041, 4042,
			4071, 4089, 3755, 4099, 4109, 4164, 4302, 4506, 4511, 4513, 4515, 4551, 4567, 4708, 4716, 4724, 4745, 4753,
			4857, 4858, 4859, 4880, 4881, 4882, 4883, 4904, 4905, 4906, 4907, 4952, 4953, 4954, 4955, 4976, 4977, 4978,
			4979, 5013, 5014, 5554, 5574, 6109, 6128, 6131, 6137, 6182, 6188, 6335, 6337, 6339, 6345, 6355, 6365, 6375,
			6382, 6392, 6400, 6918, 6656, 2581, 7539, 7394, 7396, 7534, 5574, 6885, 6858, 6860, 6862, 6856, 6326, 6128,
			6137, 7400, 7323, 7325, 7327, 7003, 10547, 10548, 10608, 10802, 10804, 10806, 10941, 11280, 12419, 12457,
			13876, 7112, 7124, 6392, 6400, 6326, 12855, 12856, 33024 };
	 ...
	 */
	public static int body[] = { 10370, 10378, 10386, 12492, 12500, 12508, 7390, 20840, 7392, 577, 10400, 10404, 10408, 10412, 10416, 10420, 10424, 10428, 10432, 10436,
			...
			1035, 33101, 33107, 33158, 33169 };

	/**
	 * Leg armour that covers your legs.
	 */
	public static int legs[] = { 33108, 10438, 10434, 20842, 10430, 10426, 10422, 10418, 10414, 10410, 10406, 10402, 7609, 2522, 7378,
	 ...
	 */
	public static int platebody[] = { 21892, 10370, 10378, 10386, 12492, 12500, 12508, 12277, 12235, 12205, 11020, 13887, 13884, 13858, 10551, 10338, 7608, 2520, 430,
			...
			5034, 7392, 1035,577,22327, 6322, 33101, 33107, 33158, 13104, 13105, 13106, 13107, 33919  };

	/**
	 * Body armour that covers your body and arms.
	 */
	private static String[] fullbody = { "crystal", "dragon platebody", "druidic", "zamorak", "guthix", "saradomin", "bandos", "ancient", "armadyl", "platebody", "tekton", "dagon", "dagon'", "dagon' hai top", "vorkath", "varrock", "plate", "top", "wings", "blouse", "monk's robe", "shirt",
	 ...
	 */
	private static String[] fullhat = { "skeleton mask", "glowing skeleton mask", "splitbark helm", "kandarin", "mystic", "black mask", "highwayman mask", "mime mask",
			"facemask", "ironman helm", "grim reaper", "imp mask", "mage hat", "med helm", "coif", "Dharok's helm",
			"hood", "Initiate helm", "Coif", "Helm of neitiznot", "Armadyl helmet", "Berserker helm", "Archer helm",
			"Farseer helm", "Warrior helm", "Void", "reindeer", "cowl", "Void ranger helm", "Blacksmith's_helm",
			"black mask", "Robin hood hat", "pith helmet", "spiny helmet", "gold helmet",
			"crab helmet", "3rd age full helmet", "dwarven helmet", "camo"
	};

	/**
	 * Headgear that covers your head and your face.
	 */
	private static String[] fullmask = { "frosty", "sirenic", "pernix", "bunnyman", "slayer_helm", "slayer helm", "helm", "Tekton", "Kbd_helmet", "Vorkath_helmet", "kandarin headgear 4", "jonas", "grim reaper hood", "mummy's head", "cyclops head", "kandarin headgear 4", "helmet_imbued", "helm_(g)", "Bronze_full_helm", "Iron_full_helm",
			...
			"ankou", "demon", "mummy", "Banshee", "Goblin mask", "Jack_lantern_mask", "h'ween",
	...
	static {
		try {
			...
			for (String data : stackableData) {
				...
				itemStackable[33006] = true;
				itemStackable[33005] = true;
				itemStackable[22447] = true;
				itemStackable[33423] = true;
				itemStackable[33435] = true;
				itemStackable[33466] = true;
				itemStackable[23866] = true;
				itemStackable[23867] = true;
			}
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			...
			itemIsNote[22125] = true;

			itemIsNote[22126] = false;

			itemIsNote[22124] = false;
			
			itemIsNote[22786] = false;
			
			itemIsNote[22787] = true;
			
			itemIsNote[22731] = false;
			
			itemIsNote[22732] = true;
			
			itemIsNote[22447] = true;
			
			itemIsNote[22446] = false;
			
			itemIsNote[22448] = false;
			
			//tob potions (bastion, battlemage)
			itemIsNote[22449] = false;
			itemIsNote[22450] = true;
			itemIsNote[22452] = false;
			itemIsNote[22453] = true;
			itemIsNote[22455] = false;
			itemIsNote[22456] = true;
			itemIsNote[22458] = false;
			itemIsNote[22459] = true;
			itemIsNote[22461] = false;
			itemIsNote[22462] = true;
			itemIsNote[22464] = false;
			itemIsNote[22465] = true;
			itemIsNote[22467] = false;
			itemIsNote[22468] = true;
			itemIsNote[22470] = false;
			itemIsNote[22471] = true;
			itemIsNote[22443] = false;
			itemIsNote[22444] = true;
			
			dataIn.close();
			log.info("Loaded {} noted configurations", counter);
		} catch (IOException e) {
			log.warn("Critical error while loading notedata! {}", e);
		}
		...
		try {
			...
			dataIn.close();
			log.info("Loaded {} equipment configurations", counter);
		} catch (IOException e) {
			log.warn("Critical error while loading equipment configuration! {}", e);
		}
	}
}
