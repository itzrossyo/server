...
@ScriptSettings(
		npcNames = { "Lava strykewyrm" },
		npcIds = { 3822, 3824 }
	)

public class LavaStrykewyrm extends CombatScript {
	
	private static final int UNDER = 3824, MAIN = 3822;
	...
	public int attack(NPC npc, Entity target) {
		...
		//int movePosition = Misc.random(1, 50);
		
//		/*
//		 * Wyrm moving position
//		 */
//		if (movePosition == 5) {
//			CycleEvent moveEvent = new CycleEvent() {
//				@Override
//				public void execute(CycleEventContainer container) {
//						if (target == null || target.asPlayer().isDead) {
//							container.stop();
//						}
//				}
//			};
//			CycleEventHandler.getSingleton().addEvent(-1, npc, moveEvent, 1);
//			npc.startAnimation(1);//zulrah dive animation
//		}
