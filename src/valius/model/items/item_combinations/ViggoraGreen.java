...
public class ViggoraGreen extends ItemCombination {

	public ViggoraGreen(Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendItemStatement("You combined the items and created the Viggoras chainmace (Toxic).", 33780);
