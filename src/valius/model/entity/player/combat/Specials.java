...
public enum Specials {
	...
	INFERNAL_BOW(new InfernalBow()),
	INFERNAL_STAFF(new InfernalStaff()),
	INFERNAL_SWORD(new InfernalSword()),
	INFERNAL_HAMMER(new InfernalHammer()),
	ZAMORAK_GODBOW(new ZamorakGodbow()),
	BANDOS_GODBOW(new BandosGodbow()),
	SARADOMIN_GODBOW(new SaradominGodbow()),
	ZILYANAS_GODBOW(new ZilyanasGodbow()),
	...
	DAWNBRINGER(new Dawnbringer()),
	KORASI(new KorasiSpecial()),
	BOOGIE_BOW(new BoogieBow());
