...
public class CrawsBlue extends ItemCombination {

	public CrawsBlue(Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendItemStatement("You combined the items and created the Craws bow (Blue flame).", 33781);
		player.crawCharge = 0;
