...
public class Obelisks {
	...
	public void activate(Player player, int objectId) {
		...
		World.getWorld().getGlobalObjects().add(new GlobalObject(14825, x, y, 0, 0, 10, 14, objectId));
		World.getWorld().getGlobalObjects().add(new GlobalObject(14825, x + 4, y, 0, 0, 10, 14, objectId));
		World.getWorld().getGlobalObjects().add(new GlobalObject(14825, x, y + 4, 0, 0, 10, 14, objectId));
		World.getWorld().getGlobalObjects().add(new GlobalObject(14825, x + 4, y + 4, 0, 0, 10, 14, objectId));
	...
	static final class Event implements CycleEvent {
