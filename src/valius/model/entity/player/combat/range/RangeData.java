...
public class RangeData {
	...
	public static void fireProjectileNpc(Player c, int delay) {
		if (c.oldNpcIndex > 0) {
			if (NPCHandler.npcs[c.oldNpcIndex] != null) {
				...
				if (c.getCombat().usingDbow() || c.lastWeaponUsed == 33536 || c.lastWeaponUsed == 33531)
	...
	public static int getRangeStr(int i) {
		...
		int[][] data = { 
				...
				//custom starts
				{33094, 75}, {11785, 30}, {33141, 87}, {33140, 87}, {33139, 87}, {33116, 107}, {33551, 147},
				{33529, 157}, {33281, 157}, {33763, 157}, {33531, 63}, {33536, 63}, {33030, 162},  {33671, 162},
				{20997, 162}, {33562, 162}, {33752, 162}, {33525, 162}, {33424, 162}, {33119, 167}, {33754, 172},
				{33908, 177}, {33909, 177}, {33910, 177}, {33911, 177}, {33914, 177}, {33922, 177}, {33812, 87}, {33813, 87}, {33814, 87}, 
				{33594, 172}, {33117, 25}, {33114, 90}, {33124, 105}, {33578, 105}, 
				
				
				//Bows(check all bows and add proper bonuses)
				{23901, 42}, {23902, 88}, {23903, 138}, {23983, 147},//crystal bows (the gauntlet)
			    {22550, 30}, { 33781, 40 }, { 33782, 40 }, { 33783, 40 }, { 33891, 20 },
				...
				{ 9244, 117 }, { 9245, 120 }, { 9976, 0 }, { 9977, 15 }, { 10033, 60 }, { 10034, 85 }, { 11959, 95 }, { 11212, 60 }, { 11230, 65 }, { 12926, 53 }, { 33466, 100 }, { 33005, 120 }, {33006, 100} };
	...
	public static int getRangeStartGFX(Player c) {
		...
		int[][] data = {
				// KNIFES
				{ 863, 220 }, { 864, 219 }, { 865, 221 }, { 866, 223 }, { 867, 224 }, { 868, 225 }, { 869, 222 },  { 22804, 1630 },

				// DARTS
				{ 806, 232 }, { 807, 233 }, { 808, 234 }, { 809, 235 }, { 810, 236 }, { 811, 237 },

//				// JAVELINS
				{ 825, 206 }, { 826, 207 }, { 827, 208 }, { 828, 209 }, { 829, 210 }, { 830, 211 }, { 33005, 1619 },

				// AXES
				{ 800, 36 }, { 801, 35 }, { 802, 37 }, { 803, 38 }, { 804, 39 }, { 805, 48 }, { 20849, 1319 }, { 33006, 1624},

				// ARROWS
				{ 882, 19 }, { 884, 18 }, { 886, 20 }, { 888, 21 }, { 890, 22 }, { 892, 24 }, { 11212, 1116 },

				//craws bow
				{22550, 1611}, {22547, 1611}, {33781, 1611}, { 33782, 1611 }, { 33783, 1611 },
				// CRYSTAL_BOW
				{ 33030, 250 },  {33908, 250}, {33909, 250}, {33910, 250}, {33911, 250}, {33914, 250}, {33922, 250}, { 4212, 250 }, {23901, 250}, {23902, 250}, {23903, 250},  {23983, 250}, { 4214, 250 }, { 4215, 250 }, { 4216, 250 }, { 4217, 250 }, { 4218, 250 }, { 4219, 250 }, { 4220, 250 }, { 4221, 250 }, { 4222, 250 },
				{ 4223, 250 }, };
		for (int l = 0; l < data.length; l++) {
			if (item == data[l][0]) {
				str = data[l][1];
		...
		if (c.playerEquipment[3] == 33531 || c.playerEquipment[3] == 33536 || c.playerEquipment[3] == 11235 || c.playerEquipment[3] == 12765 || c.playerEquipment[3] == 12766 || c.playerEquipment[3] == 12767 || c.playerEquipment[3] == 12768) {
	...
	public static int getRangeProjectileGFX(Player c) {
		...
		//Boogie spec, add projectile 1111 here for 2x double arrow shots
		...
		if (c.playerEquipment[c.playerWeapon] == 9185 || c.playerEquipment[c.playerWeapon] == 21902  || c.playerEquipment[c.playerWeapon] == 33578  || c.playerEquipment[c.playerWeapon] == 33117  || c.playerEquipment[c.playerWeapon] == 11785 || c.playerEquipment[c.playerWeapon] == 33094 || c.playerEquipment[c.playerWeapon] == 33124 || c.playerEquipment[c.playerWeapon] == 21012 || c.playerEquipment[c.playerWeapon] == 33114)
			return 27;
		int str = -1;
		...
		int[][] data = {
				// KNIFES
				{ 863, 213 }, { 864, 212 }, { 865, 214 }, { 866, 216 }, { 867, 217 }, { 868, 218 }, { 869, 215 }, { 22804, 1622 },
				...
				// AXES
				{ 800, 36 }, { 801, 35 }, { 802, 37 }, { 803, 38 }, { 804, 39 }, { 805, 41 }, { 20849, 1320 }, { 33005, 1619}, { 33006, 1624},

				// ARROWS
				{ 882, 19 }, { 884, 18 }, { 886, 20 }, { 888, 21 }, { 890, 22 }, { 892, 24 }, { 11212, 1116 },

				// CHINCHOMPA
				{ 10033, 908 }, { 10034, 909 }, { 11959, 909 },  { 33466, 909 },

				//craws bow
				{22547, 1611}, {22550, 1611}, {33781, 1611}, { 33782, 1611 }, { 33783, 1611 },
				// OTHERS
				{ 6522, 442 }, { 4740, 27 }, {23901, 250}, {23902, 250}, {23903, 250},  {23983, 250}, { 4212, 249 }, { 4214, 249 }, { 4215, 249 }, { 4216, 249 }, { 4217, 249 }, { 4218, 249 }, { 4219, 249 }, { 4220, 249 }, { 4221, 249 },
				{ 4222, 249 }, { 4223, 249 }, };
		for (int l = 0; l < data.length; l++) {
			if (ammo == data[l][0]) {
				str = data[l][1];
