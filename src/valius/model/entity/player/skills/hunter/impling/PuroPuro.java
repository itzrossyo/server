...
public class PuroPuro {
	...
	public static void magicalWheat(Player player) {
		int x = player.getX(), x2 = x;
		int y = player.getY(), y2 = y;
		...
		final int goX = x2 - x, goY = y2 - y;
		String direction = goX > 0 ? "EAST" : goX < 0 ? "WEST" : goY < 0 ? "SOUTH" : "NORTH";
		player.setForceMovement(x2, y2, 0, 200, direction, 6594);
