...
/**
 * 
 * @author Divine | 6:41:39 a.m. | Sep. 18, 2019
 *
 */

public class EventMysteryBox {

	/**
	 * The item id of the mystery box required to trigger the event
	 */
	public static final int MYSTERY_BOX = 33717;
	...
	items.put(ItemRarity.UNCOMMON,
		...
		items.put(ItemRarity.RARE,
				Arrays.asList(
						...
						new Item(33697, 1),
						new Item(33705, 1),
						new Item(33718, 1),//pet mimic
						new Item(33509, 1))//jester hat
				);
		
		items.put(ItemRarity.VERY_RARE,
				Arrays.asList(
						new Item(33707),//Elymas
						new Item(33708),
						new Item(33709),
						new Item(33710),
						new Item(33711),
	 ...
	 */
	public EventMysteryBox(Player player) {
		this.player = player;
	}
	...
	public void reward() {
		...
		if (random > 90) {
			...
			DiscordBot.sendMessage("valius-bot","[Loot Bot] " + Misc.formatPlayerName(player.playerName) + " hit the jackpot and received a "+name+" from an Event Mystery Box!");
		}
	...
	public void openInterface() {
		...
		spinNum = 0;
		// Open
		player.getPA().sendString("Event Mystery Box", 47002);
