...
@ScriptSettings(npcIds = { 3373 })

public class RevenantWyvern extends CombatScript {
	...
	public int attack(NPC npc, Entity target) {
		...
		if (target.asPlayer().protectingMelee()) {
			switch (randomAttack) {
				case 1:
					handleHit(npc, target, CombatType.MAGE, MAGE_PROJECTILE, new Hit(Hitmark.HIT, getRandomMaxHit(npc, target, CombatType.MAGE, 35), 3));
					break;
				case 2:
					handleHit(npc, target, CombatType.RANGE, RANGE_PROJECTILE, new Hit(Hitmark.HIT, getRandomMaxHit(npc, target, CombatType.RANGE, 35), 3));
					break;
			}
		} 
		 ...
		 */
			...
			switch (randomAttack) {
				case 1:
					handleHit(npc, target, CombatType.MELEE, new Hit(Hitmark.HIT, getRandomMaxHit(npc, target, CombatType.MELEE, 35), 1));
					break;
				case 2:
					handleHit(npc, target, CombatType.RANGE, RANGE_PROJECTILE, new Hit(Hitmark.HIT, getRandomMaxHit(npc, target, CombatType.RANGE, 35), 3));
					break;
		 ...
		 */
			...
			switch (randomAttack) {
				case 1:
					handleHit(npc, target, CombatType.MELEE, new Hit(Hitmark.HIT, getRandomMaxHit(npc, target, CombatType.MAGE, 35), 1));
					break;
				case 2:
					handleHit(npc, target, CombatType.MAGE, MAGE_PROJECTILE, new Hit(Hitmark.HIT, getRandomMaxHit(npc, target, CombatType.MAGE, 35), 3));
					break;
