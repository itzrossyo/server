...
public class SkillInterfaces {
	...
	public void attackComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("65", "Etheral Sword", 33155, 7);
			menuLine("68", "Flameburst Sword", 11824, 8);
			menuLine("70", "Zamorakian Spear", 11824, 9);
			menuLine("70", "Abyssal Whip", 4151, 10);
			menuLine("70", "Saradomin Sword", 11838, 11);
			menuLine("70", "Primal Weaponry", 33360, 12);
			menuLine("75", "Saradomin's Blessed Sword", 12809, 13);
			menuLine("75", "Abyssal Tentacle", 12006, 14);
			menuLine("75", "Godswords", 11802, 15);
			menuLine("75", "K'ril Swords", 33172, 16);
			menuLine("75", "Ancient Sword", 33273, 17);
			menuLine("75", "Stunning Hammer", 33326, 18);
			menuLine("75", "Shadow Lord Weaponry", 33797, 19);
			menuLine("78", "Korasi's Sword(With 10 Defence)", 33370, 20);
			menuLine("80", "Chaotic Weaponry", 33031, 21);
			menuLine("82", "Dominion Weaponary", 33113, 22);
			menuLine("83", "Corrupt Longsword", 33561, 23);
			menuLine("85", "Tekton Longsword", 33258, 24);
			menuLine("85", "Justiciar Longsword", 33272, 25);
			menuLine("85", "Annihilation", 33528, 26);
			menuLine("85", "Infernal Weaponry", 33278, 27);
			menuLine("87", "Elder Maul(With 87 Strength)", 21003, 28);
			menuLine("87", "Scythe of Vitur(With 87 Strength)", 22325, 29);
			menuLine("87", "Ghrazi Rapier", 22324, 30);
			menuLine("90", "Sword Of Edicts", 33872, 31);
			menuLine("90", "Noxious Scythe", 33755, 32);
	...
	public void defenceComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("5", "Spiny Helmet", 4551, 3);
			menuLine("10", "Hard Leather Body", 1131, 4);
			menuLine("20", "Studded Body(With 20 Ranged)", 1133, 5);
			menuLine("20", "Initiate Platemail(With 10 Prayer)", 5575, 6);
			menuLine("20", "Mirror Shield(with 20 Slayer)", 4156, 7);
			menuLine("30", "Snakeskin armour(With 30 Ranged)", 6322, 8);
			menuLine("40", "Green Dragonhide Body(With 40 Ranged)", 1135, 9);
			menuLine("40", "Blue Dragonhide Body(With 40 Ranged)", 2499, 10);
			menuLine("40", "Red Dragonhide Body(With 40 Ranged)", 2501, 11);
			menuLine("40", "Black Dragonhide Body(With 40 Ranged)", 2503, 12);
			menuLine("40", "Spined Armour(With 40 Ranged)", 6133, 13);
			menuLine("40", "Rock-shell Armour", 6129, 14);
			menuLine("45", "Berserker Helm", 3751, 15);
			menuLine("45", "Warrior Helm", 3753, 16);
			menuLine("45", "Archer Helm", 3749, 17);
			menuLine("45", "Farseer Helm", 3755, 18);
			menuLine("50", "Granite Shield(With 50 Strength)", 3122, 19);
			menuLine("60", "TokTz-Ket-Xil(Obsidian Shield)", 6524, 20);
			menuLine("68", "Occult Armour", 33825, 21);
			menuLine("70", "Crystal Shield(With 50 Agility)", 4224, 22);
			menuLine("70", "Avernic Defender(With 70 attack)", 22322, 23);
			menuLine("70", "Primal Armour", 33358, 24);
			menuLine("70", "Slayer Armour", 33372, 25);
			menuLine("70", "Celestial Armour", 33348, 26);
			menuLine("75", "Justiciar Armour", 22327, 27);;
			menuLine("75", "Stunning Katagon Armour", 33327, 28);
			menuLine("75", "Bloodknight Armour", 33583, 29);
			menuLine("75", "Colossal Armour", 33313, 30);
			menuLine("75", "Ancient Armour", 33331, 31);
			menuLine("75", "Xeric Armour", 33506, 32);
			menuLine("75", "Shadow Lord Armour", 33793, 33);
			menuLine("80", "Torva Armour", 33022, 34);
			menuLine("82", "Tekton Armour", 33107, 35);
			menuLine("82", "Vorkath Armour", 33101, 36);
			menuLine("90", "Noxious Armour", 33598, 37);
			;
	...
	public void rangedComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("68", "Flameburst bow", 33812, 9);
			menuLine("70", "Crystal Bow(With 50 Agility)", 4212, 10);
			menuLine("70", "Godbows", 33141, 11);
			menuLine("75", "Zilyana Longbow", 33116, 12);
			menuLine("75", "Toxic Blowpipe", 12926, 13);
			menuLine("82", "Strkyebow", 33551, 14);
			menuLine("85", "Infernal Bow", 33281, 15);
			menuLine("85", "Decimation", 33529, 16);
			menuLine("87", "Twisted Bow", 20997, 17);
			menuLine("87", "Zaryte Bow", 33030, 18);
			menuLine("88", "Superior Twisted Bow", 33119, 19);
			menuLine("90", "Noxious Longbow", 33594, 20);
			menuLine("92", "Seren Godbow", 33911, 21);
			...
			menuLine("70", "Karil's Equipment(With 70 Defence)", 4736, 30);
			menuLine("70", "Armadyl Gear(With 70 Defence)", 11828, 31);
			menuLine("70", "Kbd Equipment(With 70 Defence)", 33130, 32);
			menuLine("70", "Dragonfire Ward(With 75 Defence)", 22002, 33);
			menuLine("75", "Grotesque Equipment(With 75 Defence)", 33567, 34);
			menuLine("75", "Twisted Buckler(With 75 Defence)", 21000, 35);
			menuLine("75", "Pegasian Boots(With 75 Defence)", 13237, 36);
			menuLine("80", "Pernix Equipment(With 80 Defence)", 33025, 37);
			menuLine("90", "Sirenic Equipment(With 90 Defence)", 33919, 38);
			...
			menuLine("80", "Chaotic Crossbow", 33094, 4);
			menuLine("82", "Dominion Crossbow", 33114, 5);
			menuLine("87", "Twisted Crossbow", 33124, 6);
	...
	public void prayerComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("70", "Arcane Spirit Shield(With 75 Defence and 65 Magic)", 12825, 4);
			menuLine("70", "Spectral Spirit Shield(With 75 Defence and 65 Magic)", 12821, 5);
			menuLine("75", "Elysian Spirit Shield(With 75 Defence)", 12817, 6);
			menuLine("80", "Divine Spirit Shield(With 75 Defence)", 32991, 7);
			menuLine("80", "Reflective Spirit Shield(With 80 Defence)", 33788, 8);
			menuLine("80", "Shadow SSpirit Shield(With 80 Defence)", 33787, 9);
			menuLine("80", "Siphon Spirit Shield(With 80 Defence)", 33789, 10);
	...
	public void magicComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("70", "Dagon'hai Armour(With 40 Defence)", 33158, 29);
			menuLine("75", "Ancestral Armour(With 65 Defence)", 21021, 30);
			menuLine("75", "K'ril Armour(With 75 Defence)", 33169, 31);
			menuLine("80", "Virtus Armour(With 80 Defence)", 33028, 32);
			...
			menuLine("75", "Trident Of The Seas", 11907, 25);
			menuLine("75", "Staff Of Light", 22296, 26);
			menuLine("75", "Staff Of The Dead(With 75 Attack)", 11791, 27);
			menuLine("75", "Toxic Staff Of The Dead(With 75 Attack)", 12904, 28);
			menuLine("75", "Staff Of The Dead(With 75 Attack)", 11791, 29);
			menuLine("75", "Trident Of The Swamp", 12899, 30);
			menuLine("80", "Chaotic staff", 33095, 31);
			menuLine("82", "Necrolord staff", 33279, 32);
			menuLine("85", "Dominion staff", 33112, 33);
			menuLine("85", "Obliteration staff", 33530, 34);
			menuLine("85", "Staff Of Darkness", 33553, 35);
			menuLine("85", "Infernal staff", 33277, 36);
			menuLine("87", "Kodai Wand", 21006, 37);
			menuLine("87", "Sanguinesti staff", 22323, 38);
			menuLine("87", "Twisted Staff", 33470, 39);
	...
	public void agilityComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery", c.getItems().skillcapes[Skill.AGILITY.getId()][0], 1);
	...
	public void herbloreComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("92", "Super Antifire \\n Antifire Potion, Ground Superior Bones", 21978, 27);
	...
	public void hunterComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("77", "Revenant implings", 33773, 13);
			menuLine("83", "Dragon implings", 11256, 14);
