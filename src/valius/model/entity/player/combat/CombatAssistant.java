...
import valius.model.entity.player.combat.magic.MagicConfig;
import valius.model.entity.player.combat.magic.MagicExtras;
import valius.model.entity.player.combat.magic.MagicMaxHit;
import valius.model.entity.player.combat.magic.MagicRequirements;
import valius.model.entity.player.combat.melee.CombatPrayer;
import valius.model.entity.player.combat.melee.MeleeData;
import valius.model.entity.player.combat.melee.MeleeExtras;
import valius.model.entity.player.combat.melee.MeleeMaxHit;
import valius.model.entity.player.combat.melee.MeleeRequirements;
import valius.model.entity.player.combat.melee.MeleeSpecial;
import valius.model.entity.player.combat.range.Bow;
import valius.model.entity.player.combat.range.RangeData;
import valius.model.entity.player.combat.range.RangeExtras;
import valius.model.entity.player.combat.range.RangeMaxHit;
...
public class CombatAssistant {
	...
	public boolean checkMultiScytheReqs(int i) {
		return MeleeExtras.checkMultiScytheReqs(c, i);
	}
	...
	public boolean checkMultiScytheReqsNPC(int i) {
		return MeleeExtras.checkMultiScytheReqsNPC(i);
	}
