package valius.content.kill_streaks;
		...
		ROGUE(10, new KillstreakReward(2) {
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(13307, 20)) {
						World.getWorld().getItemHandler().createGroundItem(player, 13307, player.getX(), player.getY(), player.getHeight(), 20);
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(13307, 30)) {
						World.getWorld().getItemHandler().createGroundItem(player, 13307, player.getX(), player.getY(), player.getHeight(), 30);
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(13307, 40)) {
						World.getWorld().getItemHandler().createGroundItem(player, 13307, player.getX(), player.getY(), player.getHeight(), 40);
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(13307, 50)) {
						World.getWorld().getItemHandler().createGroundItem(player, 13307, player.getX(), player.getY(), player.getHeight(), 50);
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(13307, 60)) {
						World.getWorld().getItemHandler().createGroundItem(player, 13307, player.getX(), player.getY(), player.getHeight(), 60);
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(13307, 70)) {
						World.getWorld().getItemHandler().createGroundItem(player, 13307, player.getX(), player.getY(), player.getHeight(), 70);
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(13307, 100)) {
						World.getWorld().getItemHandler().createGroundItem(player, 13307, player.getX(), player.getY(), player.getHeight(), 100);
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(13307, 120)) {
						World.getWorld().getItemHandler().createGroundItem(player, 13307, player.getX(), player.getY(), player.getHeight(), 120);
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(13307, 150)) {
						World.getWorld().getItemHandler().createGroundItem(player, 13307, player.getX(), player.getY(), player.getHeight(), 150);
