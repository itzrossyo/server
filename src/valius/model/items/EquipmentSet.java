...
public enum EquipmentSet {
		...
		CAHRIMS(new int[][] { { 33634, 33635, 33636, 33637 } }),
		CDHAROKS(new int[][] { { 33638, 33639, 33640, 33641 } }),
		CGUTHANS(new int[][] { { 33642, 33643, 33644, 33645 } }),
		CKARILS(new int[][] { { 33646, 33647, 33648, 33649 } }),
		CTORAGS(new int[][] { { 33650, 33651, 33652, 33653 } }),
		CVERACS(new int[][] { { 33654, 33655, 33656, 33657 } }),
		IRON_MAN_ARMOUR(new int[][] { { 12810, 12811, 12812 } }),
		GROUP_IRON_MAN_ARMOUR(new int[][] { { 33601, 33602, 33603 } }),
		HC_IRON_MAN_ARMOUR(new int[][] { { 20792, 20794, 20796 } }), 
		DESERT_ROBES(new int[][] { { 1833, 1835 } }),
		ULTIMATE_IRON_MAN_ARMOUR(new int[][] { { 12813, 12814, 12815 } }),
		BLOOD_JUSTICIAR_SET(new int[][] { { 33375, 33376, 33377 } }),
		CURSED_GROTESQUE(new int[][] { { 33322, 33323, 33324 } }),
		;
