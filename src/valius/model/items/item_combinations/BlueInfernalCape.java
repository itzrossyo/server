...
public class BlueInfernalCape extends ItemCombination {

	public BlueInfernalCape(Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendItemStatement("You combined the items and created the Blue Infernal Cape.", 33143);
