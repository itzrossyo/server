...
public class CycleEventHandler {
	...
	public CycleEventContainer addEvent(int id, Object owner, CycleEvent event, int cycles) {
		return addEvent(id, owner, event, cycles, false);
	}

	public CycleEventContainer addEvent(int id, Object owner, CycleEvent event, int cycles, boolean randomized) {
		CycleEventContainer container = new CycleEventContainer(id, owner, event, cycles, randomized);
	...
	public CycleEventContainer addEvent(Object owner, CycleEvent event, int cycles) {
		return addEvent(-1, owner, event, cycles);
	}
