	...
	public static void multiSpellEffect(Player c, int playerId, int damage) {
		...
		case 13023:
			if (System.currentTimeMillis() - PlayerHandler.players[playerId].reduceStat > 35000) {
				Player plr = PlayerHandler.players[playerId];
				plr.reduceStat = System.currentTimeMillis();
				plr.getSkills().decreaseLevelOrMin((plr.getSkills().getActualLevel(Skill.ATTACK) * 10) / 100, Skill.ATTACK);
			}
			break;
		case 12919: // blood spells
		case 12929:
