...
public class ItemOptionTwo implements PacketType {
	...
	public void processPacket(Player player, int packetType, int packetSize) {
		...
		int slot = player.getInStream().readSignedWordBigEndianA();
		...
		Item item = player.getItems().getItemAtSlot(slot);
		player.getQuestManager().onItemClick(interfaceId, 2, item);
		...
		case 19732:
			...
			//check for ether
		case 21816:
			player.sendMessage("You currently have " + player.ethereumCharge + " charges left in your Bracelet of ethereum.");
			break;
		case 22550:
			player.sendMessage("You currently have " + player.crawCharge + " charges left in your Craws bow.");
			break;
		case 22555:
			player.sendMessage("You currently have " + player.thammaronCharge + " charges left in your Thammarons staff.");
			break;
		case 22545:
			player.sendMessage("You currently have " + player.viggoraCharge + " charges left in your Viggoras chainmace.");
			break;
			
			
		//Zulrah Dismantles
		case 12927: //serp
			player.getItems().deleteItem(12927, 1);
			player.getItems().addItem(12934, (Misc.random(19000, 20500)));
			break;
		case 12932: //magic fang
			player.getItems().deleteItem(12932, 1);
			player.getItems().addItem(12934, (Misc.random(19000, 20500)));
			break;
		case 12922://tanz fang
			player.getItems().deleteItem(12922, 1);
			player.getItems().addItem(12934, (Misc.random(19000, 20500)));
			break;
		...
		case 227:
			...
			player.sendMessage("You have emptied the vial of water");
			break;
		...
		case 20243:
			...
			break;
		case 13078:
			player.getPA().spellTeleport(3304, 2789, 0, false);
			break;
		case 13136:
		...
		case 13117:
			if (player.getSkills().getLevel(Skill.PRAYER) < player.getSkills().getActualLevel(Skill.PRAYER)) {
