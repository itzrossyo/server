...
/**
 * 
 * @author Divine | 11:29:09 p.m. | Oct. 15, 2019
 *
 */

@ScriptSettings(npcIds = { 4500 })
//T4
public class SkeletalWarrior extends CombatScript {
	
	@Override
	public int attack(NPC npc, Entity target) {
		npc.startAnimation(1833);
		handleHit(npc, target, CombatType.MELEE, new Hit(Hitmark.HIT, getRandomMaxHit(npc, target, CombatType.MELEE, 10), 1));
			return 4;
	}
