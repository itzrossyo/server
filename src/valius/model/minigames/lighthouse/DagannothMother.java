...
public final class DagannothMother extends SingleInstancedArea {
	...
	public void init() {
		...
		World.getWorld().getEventHandler().submit(new Event<Player>("dagannoth_mother", player, 5) {
			...
			public void execute() {
				...
				World.getWorld().getNpcHandler().spawnNpc(player, 983, SPAWN_X, SPAWN_Y, height, 0, HITPOINTS, MAXHIT, ATTACK, DEFENCE, true, false);
				npcId = 983;
				super.stop();
			}
