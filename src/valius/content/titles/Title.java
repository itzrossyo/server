...
import valius.content.achievement.Achievements.Achievement;
...
public enum Title implements Comparator<Title> {
	...
	SAPPHIRE("Sapphire", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.SAPPHIRE);
		}
	}, "This title is for contributors. You must be a contributor to purchase and display this title."),

	EMERALD("Emerald", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.EMERALD);
		}
	}, "This title is for sponsors. You must be a sponsor to purchase and display this title."),

	RUBY("Ruby", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.RUBY);
		}
	}, "This title is for supporters. You must be a supporter to purchase and display this title."),

	DIAMOND("Diamond", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.DIAMOND);
		}
	}, "This title is for V.I.P's. You must be a V.I.P to purchase and display this title."),

	DRAGONSTONE("Dragonstone", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.DRAGONSTONE);
		}
	...
	HC_IRON_MAN("Hardcore", 0, TitleCurrency.NONE, new TitleRequirement() {

		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.HC_IRONMAN);
		}
	}, "To receive access to this title, a player must be on the hardcore ironman game-mode."),
