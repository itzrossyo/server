...
public class EventBossChest {
	
	
	/*
	 * The ID of the Event Key
	 */
	public static final int EVENT_KEY = 13303;
	...
	static {
		...
		Arrays.asList(
				new Item(995, 500_000 + Misc.random(1_000_000)),//gold
		...
		items.put(ItemRarity.RARE, Arrays.asList(
				...
				new Item(33083, 1),//Tokhaar cape
				new Item(19841, 1),//Master clue casket
				new Item(12004, 1)//kraken tent
			));
		
		items.put(ItemRarity.VERY_RARE, Arrays.asList(
				new Item(33094, 1),//Chaotic Crossbow
				new Item(33095, 1),//Chaotic Staff
				new Item(33096, 1),//Chaotic Shield
				new Item(33032, 1),//Chaotic Longsword
				new Item(33247, 1),//Tarn pet
				new Item(33031, 1),//Chaotic Rapier
				new Item(33336, 1),//ancient armor set
				new Item(33331, 1),
				new Item(33332, 1),
				new Item(33334, 1)
				));
	...
	public static void SpawnChest() {
		  World.getWorld().getGlobalObjects().add(new GlobalObject(EventBossChest.EVENT_CHEST, 3177, 3007, 0, 0, 10));
		  World.getWorld().getGlobalObjects().add(new GlobalObject(EventBossChest.EVENT_CHEST, 3540, 3312, 0, 0, 10));
		  World.getWorld().getGlobalObjects().add(new GlobalObject(EventBossChest.EVENT_CHEST, 2939, 3426, 0, 0, 10));
		  World.getWorld().getGlobalObjects().add(new GlobalObject(EventBossChest.EVENT_CHEST, 2796, 3454, 0, 0, 10));
		  World.getWorld().getGlobalObjects().add(new GlobalObject(EventBossChest.EVENT_CHEST, 2331, 3833, 0, 0, 10));
	}
