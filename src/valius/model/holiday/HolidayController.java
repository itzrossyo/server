...
import valius.model.holiday.christmas.ChristmasCycleEvent;
import valius.model.holiday.halloween.Halloween;
import valius.model.holiday.halloween.HalloweenCycleEvent;
...
public class HolidayController {
	...
	public static final Halloween HALLOWEEN = new Halloween("Halloween", new GregorianCalendar(Server.getCalendar().getInstance().get(Calendar.YEAR), Calendar.OCTOBER, 4, 0, 0),
			new GregorianCalendar(Server.getCalendar().getInstance().get(Calendar.YEAR), Calendar.OCTOBER, 30, 0, 0), new HalloweenCycleEvent());

	public static final Christmas CHRISTMAS = new Christmas("Christmas", new GregorianCalendar(Server.getCalendar().getInstance().get(Calendar.YEAR), Calendar.DECEMBER, 8, 0, 0),
