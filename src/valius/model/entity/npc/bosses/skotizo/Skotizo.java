package valius.model.entity.npc.bosses.skotizo;
...
public class Skotizo extends SingleInstancedArea {
			...
			while (!unique) {
				...
				if(altar == null) {
					...
					if (altarMapDirection[altarNumber-1] == "NORTH") {
						...
						World.getWorld().getGlobalObjects().remove(28924, 1694, 9904, height); // Remove North - Empty Altar
						World.getWorld().getGlobalObjects().add(new GlobalObject(28923, 1694, 9904, height, 2, 10, -1, -1)); // North - Awakened Altar
						World.getWorld().getNpcHandler().spawnNpc(player, AWAKENED_ALTAR_NORTH, 1694, 9904, height, 0, 100, 10, 200, 200, false, false);
						altarCount++;
						northAltar = true;
						...
						World.getWorld().getGlobalObjects().remove(28924, 1696, 9871, height); // Remove South - Empty Altar
						World.getWorld().getGlobalObjects().add(new GlobalObject(28923, 1696, 9871, height, 0, 10, -1, -1)); // South - Awakened Altar
						World.getWorld().getNpcHandler().spawnNpc(player, AWAKENED_ALTAR_SOUTH, 1696, 9871, height, 0, 100, 10, 200, 200, false, false);
						altarCount++;
						southAltar = true;
						...
						World.getWorld().getGlobalObjects().remove(28924, 1678, 9888, height); // Remove West - Empty Altar
						World.getWorld().getGlobalObjects().add(new GlobalObject(28923, 1678, 9888, height, 1, 10, -1, -1)); // West - Awakened Altar
						World.getWorld().getNpcHandler().spawnNpc(player, AWAKENED_ALTAR_WEST, 1678, 9888, height, 0, 100, 10, 200, 200, false, false);
						altarCount++;
						westAltar = true;
						...
						World.getWorld().getGlobalObjects().remove(28924, 1714, 9888, height); // Remove East - Empty Altar
						World.getWorld().getGlobalObjects().add(new GlobalObject(28923, 1714, 9888, height, 3, 10, -1, -1)); // East - Awakened Altar
						World.getWorld().getNpcHandler().spawnNpc(player, AWAKENED_ALTAR_EAST, 1714, 9888, height, 0, 100, 10, 200, 200, false, false);
						altarCount++;
						eastAltar = true;
					}
				} else {
	...
	public void init() {
		...
		World.getWorld().getGlobalObjects().add(new GlobalObject(28924, 1696, 9871, height, 0, 10, -1, -1)); // South - Empty Altar
		World.getWorld().getGlobalObjects().add(new GlobalObject(28924, 1694, 9904, height, 2, 10, -1, -1)); // North - Empty Altar
		World.getWorld().getGlobalObjects().add(new GlobalObject(28924, 1678, 9888, height, 1, 10, -1, -1)); // West - Empty Altar
		World.getWorld().getGlobalObjects().add(new GlobalObject(28924, 1714, 9888, height, 3, 10, -1, -1)); // East - Empty Altar
	}
	...
	public final void end(DisposeTypes dispose) {
		...
		if (dispose == DisposeTypes.COMPLETE) {
			...
			if (northAltar) {
				World.getWorld().getGlobalObjects().remove(28923, 1694, 9904, height); // Remove North - Awakened Altar
				NPCHandler.kill(AWAKENED_ALTAR_NORTH, height);
				player.getPA().sendChangeSprite(29232, (byte) 0);
				altarMap.remove(1);
				northAltar = false;
			...
			if (southAltar) {
				World.getWorld().getGlobalObjects().remove(28923, 1696, 9871, height); // Remove South - Awakened Altar
				NPCHandler.kill(AWAKENED_ALTAR_SOUTH, height);
				player.getPA().sendChangeSprite(29233, (byte) 0);
				altarMap.remove(2);
				southAltar = false;
			...
			if (westAltar) {
				World.getWorld().getGlobalObjects().remove(28923, 1678, 9888, height); // Remove West - Awakened Altar
				NPCHandler.kill(AWAKENED_ALTAR_WEST, height);
				player.getPA().sendChangeSprite(29234, (byte) 0);
				altarMap.remove(3);
				westAltar = false;
			...
			if (eastAltar) {
				World.getWorld().getGlobalObjects().remove(28923, 1714, 9888, height); // Remove East - Awakened Altar
				NPCHandler.kill(AWAKENED_ALTAR_EAST, height);
				player.getPA().sendChangeSprite(29235, (byte) 0);
				altarMap.remove(4);
				eastAltar = false;
			...
			//World.getWorld().getGlobalObjects().remove(28924, height);
			//World.getWorld().getGlobalObjects().remove(28923, height);
			...
			if (northAltar) {
				NPCHandler.kill(AWAKENED_ALTAR_NORTH, height);
				World.getWorld().getGlobalObjects().remove(28923, 1694, 9904, height); // Remove North - Awakened Altar
				World.getWorld().getGlobalObjects().add(new GlobalObject(28924, 1694, 9904, height, 2, 10, -1, -1)); // Add North - Empty Altar
				player.getPA().sendChangeSprite(29232, (byte) 0);
				altarMap.remove(1);
				northAltar = false;
			} else {
			...
			if (southAltar) {
				NPCHandler.kill(AWAKENED_ALTAR_SOUTH, height);
				World.getWorld().getGlobalObjects().remove(28923, 1696, 9871, height); // Remove South - Awakened Altar
				World.getWorld().getGlobalObjects().add(new GlobalObject(28924, 1696, 9871, height, 0, 10, -1, -1)); // Add South - Empty Altar
				player.getPA().sendChangeSprite(29233, (byte) 0);
				altarMap.remove(2);
				southAltar = false;
			} else {
			...
			if (westAltar) {
				NPCHandler.kill(AWAKENED_ALTAR_WEST, height);
				World.getWorld().getGlobalObjects().remove(28923, 1678, 9888, height); // Remove West - Awakened Altar
				World.getWorld().getGlobalObjects().add(new GlobalObject(28924, 1678, 9888, height, 1, 10, -1, -1)); // Add West - Empty Altar
				player.getPA().sendChangeSprite(29234, (byte) 0);
				altarMap.remove(3);
				westAltar = false;
			} else {
			...
			if (eastAltar) {
				NPCHandler.kill(AWAKENED_ALTAR_EAST, height);
				World.getWorld().getGlobalObjects().remove(28923, 1714, 9888, height); // Remove East - Awakened Altar
				World.getWorld().getGlobalObjects().add(new GlobalObject(28924, 1714, 9888, height, 3, 10, -1, -1)); // Add East - Empty Altar
				player.getPA().sendChangeSprite(29235, (byte) 0);
				altarMap.remove(4);
				eastAltar = false;
			} else {
